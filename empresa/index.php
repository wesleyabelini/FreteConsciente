    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                <p align="center"><h1>Meus fretes</h1></p><br><br>
                <table class="table table-striped">
                    <thead> <tr> <th>#</th> <th>Destino</th> <th>Cidade</th> <th>Estado</th> <th>Hora</th> <th>Stauts</th></tr> </thead>
<?php 
include("../conexao.php");
      ...
      $rows = $result->fetchAll();
        foreach ($rows as $rs) 
          { 
            ...
            $STATUS=$rs['STATUS'];
           ?>
                    <tbody> <tr> <td>#</td> <td><?PHP Echo $O_ENDERECO;?></td> <td><?php echo $O_CIDADE; ?></td> <td><?php echo $O_ESTADO;?></td> <td><?php echo $O_HORA; ?></td> <td><?php echo $STATUS;?></td></tr>  </tr></tbody>
            <?php } ?>
                </table>
                </div>
                <!-- /.row -->
